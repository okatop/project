...
<!-- 펀딩 상세 상단 오른쪽 시작 -->	
		<div class="one_quarter">
			...
			<!-- 관리자 후원 비활성화
			<button class="btn" style="width:100%;">후원하기</button> 
			-->
		</div>		
<!-- 펀딩 상세 상단 오른쪽 끝 -->		
      ...
      <div id="comments">
        ...
        <ul>
          <li class="services">
            <article class="">
              <header>
                <figure class=""><img class="imgl borderedbox inspace-5" src="../images/demo/imgl.gif" alt=""></figure>
                <address>
...
<!-- 관리자 승인 버튼  -->
	 <div align="right">
			<button type="submit" class="btn btn-outline-primary">승인하기</button>
