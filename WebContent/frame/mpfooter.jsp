...
<script src="${root}/layout/scripts/jquery.backtotop.js"></script>
<script src="${root}/layout/scripts/jquery.mobilemenu.js"></script>
<script src="${root}/layout/scripts/jquery.flexslider-min.js"></script>
</body>
</html>